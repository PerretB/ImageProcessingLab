...
int main( int argc, char** argv )
{
    ...
    int sizeFactor = 3;
    app.add_option("-F,--sizeFactor", sizeFactor, "Each dimension d of size sd is increased to size (sd-1)*sizeFactor")->required();
    ...
    Mat res_image = expand(image, sizeFactor, interpolationMethod);
